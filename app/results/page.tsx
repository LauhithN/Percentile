  ...
  const resultView = useMemo(() => {
    ...
    if (result.testType === 'reaction') {
      ...
      return {
        ...
        statLine: `${result.avg}ms average Ãƒâ€šÃ‚Â· ${best}ms best`,
    ...
    if (result.testType === 'memory') {
      return {
        ...
        statLine: `Longest ${result.longestSequence} Ãƒâ€šÃ‚Â· ${result.totalCorrect}/25 correct Ãƒâ€šÃ‚Â· ${result.avgSpeed}ms tap`,
        breakdown: [
    ...
    return {
      ...
      statLine: `Accuracy ${(accuracyRate * 100).toFixed(0)}% Ãƒâ€šÃ‚Â· ${result.avgSpeed}ms avg`,
      breakdown: [
